...
/*** DVS 0.1 individualProcess.class.php    ***/
/*** david.brett@ehess.fr          ***/
/*** web@ehess.fr                  ***/
/*** V.0.1 - September 2019        ***/
/*** COPYRIGHT EHESS/DNB           ***/
/***                               ***/
/*** Class used to process VIVO individual items,     ***/
/*** build and execute subqueries. ***/
/***                               ***/

class individualProcess extends callVivo {
    ...
    /** 
     * Build subqueries from individual entities IDs array.
     *
     ...
     * @return array.
     */
    function buildSubQueriesFromUrls(
        $dataArray,
        $format
    ) 
    {
